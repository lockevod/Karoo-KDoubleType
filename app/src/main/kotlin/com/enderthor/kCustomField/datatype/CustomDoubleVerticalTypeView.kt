...
@Composable
fun NumberWithIconVertical(leftNumber: Int, rightNumber: Int, leftIcon: Int, rightIcon: Int, iconColorLeft: ColorFilter, iconColorRight: ColorFilter,isVertical:Boolean) {
