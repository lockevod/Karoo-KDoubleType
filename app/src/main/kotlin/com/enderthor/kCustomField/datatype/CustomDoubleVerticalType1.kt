...
class CustomDoubleVerticalType1(
    ...
    override val leftAction = { settings: CustomFieldSettings -> settings.customverticalleft1 }
    override val rightAction = { settings: CustomFieldSettings -> settings.customverticalright1 }
    override val isVertical = { settings: CustomFieldSettings -> settings.ishorizontal1 }
